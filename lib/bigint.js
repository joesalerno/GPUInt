...
class BigIntPrimitive {
  ...
  add(otherBigInt) {
    ...
    if (this.sign === otherBigInt.sign) {
      ...
      const tempThisAligned = new BigIntPrimitive(thisCoeffStr, this.canvas, { forceCPU: true });
      tempThisAligned.sign = 1;
      // The exponent of tempThisAligned will be 0 from construction with a pure coefficient string.
      ...
      const tempOtherAligned = new BigIntPrimitive(otherCoeffStr, this.canvas, { forceCPU: true });
      tempOtherAligned.sign = 1;
