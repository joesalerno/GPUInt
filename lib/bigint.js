...
class BigIntPrimitive {
  ...
  _longDivide(positiveDividend, positiveDivisor) {
    ...
    for (let i = dividendLimbs.length - 1; i >= 0; i--) {
        ...
        // For _multiply_limbs_by_power_of_base, it's a static-like utility on limbs
        currentWorkingLimbs = this._multiply_limbs_by_power_of_base(currentWorkingLimbs, 1);
