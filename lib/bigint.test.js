...
describe('BigIntPrimitive', () => {
  ...
  describe('_core_multiply() - internal multiplication logic', () => {
    ...
    it('single-limb * single-limb', () => {
        ...
        mlbbSpy.mockReturnValue(new BigIntPrimitive('35', mockCanvas)); // _multiply_limb_by_bigint returns this
        // No need to mock readDataFromTexture here if _multiply_limb_by_bigint is properly mocked away for this test's focus
