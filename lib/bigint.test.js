...
describe('BigIntPrimitive', () => {
  ...
  describe('_core_multiply() - internal multiplication logic', () => {
    ...
    it('123 * 45 = 5535', () => {
      ...
      // No mock for _multiply_limb_by_bigint, use actual implementation
      // No mock for _core_add, use actual implementation

      const result = instanceForCPU._core_multiply(num1, num2);
      // num1.limbs (MSB) = [123]. Reversed LSB-first = [123]. Loop i=0.
      expect(localPrototypeMlbbSpy).toHaveBeenCalledTimes(1); // Corrected: "123" is one limb in BASE 10k
      expect(localPrototypeMlbbSpy).toHaveBeenNthCalledWith(1, 123, num2);
