...
describe('toPrecision()', () => {
  ...
  test('[TEMP DEBUG] toPrecision for 1e20, sd=21', () => {
    const num = new BigIntPrimitive('1e20');
    const directResult = num.toPrecision(21);
    console.log(`[[TEMP DEBUG Test Scope]] DIRECT call toPrecision(21): '${directResult}', type: ${typeof directResult}`);
    const result = directResult;
    console.log(`[[TEMP DEBUG Test Scope]] ASSIGNED var from toPrecision(21): '${result}', type: ${typeof result}`);
    expect(result).toBe('100000000000000000000');
  });

  test('[TEMP DEBUG] toPrecision for 1e20, sd=22', () => {
    const num = new BigIntPrimitive('1e20');
    const directResult = num.toPrecision(22);
    console.log(`[[TEMP DEBUG Test Scope]] DIRECT call toPrecision(22): '${directResult}', type: ${typeof directResult}`);
    const result = directResult;
    console.log(`[[TEMP DEBUG Test Scope]] ASSIGNED var from toPrecision(22): '${result}', type: ${typeof result}`);
